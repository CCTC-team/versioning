...
- `publish-report` — merges the run's mochawesome JSON into one combined HTML report and publishes it to GitHub Pages (report named `versioning_v1.1.1.html`, also served at the Pages root as `index.html`).
